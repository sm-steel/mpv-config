//!HOOK LUMA
//!BIND HOOKED
//!DESC Adaptive Sharpen Modern (1080p)

//--------------------------------------- Settings ------------------------------------------------

#define curve_height    1.0                  // Standard "Reference" strength.
                                             // Gives that "4K TV" crispness without looking artificial.

#define overshoot_ctrl  true                 // ENABLED: Mimics high-end TV processing.
